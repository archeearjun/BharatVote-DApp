...
export interface BharatVoteInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "electionRound",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface BharatVote extends BaseContract {
  ...
  commits: TypedContractMethod<[_voter: AddressLike], [string], "view">;

  electionRound: TypedContractMethod<[], [bigint], "view">;
  ...
  hasCommitted: TypedContractMethod<[_voter: AddressLike], [boolean], "view">;

  hasRevealed: TypedContractMethod<[_voter: AddressLike], [boolean], "view">;
