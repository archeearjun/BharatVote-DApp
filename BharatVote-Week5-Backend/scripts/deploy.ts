...
/**
 * BharatVote Deployment Script (Week 5)
 *
 ...
 */
async function main() {
  console.log("🚀 Starting BharatVote (Week 5) deployment...\n");
  ...
  // Read ABI from artifacts (ethers v6 compatible)
  const artifactsPath = path.join(__dirname, "..", "artifacts", "contracts", "BharatVote.sol", "BharatVote.json");
  let abi;
  if (fs.existsSync(artifactsPath)) {
    const artifact = JSON.parse(fs.readFileSync(artifactsPath, "utf8"));
    abi = artifact.abi;
  } else {
    // Fallback: try to get ABI from contract factory interface
    try {
      abi = JSON.parse(BharatVoteFactory.interface.formatJson());
    } catch (e) {
      console.warn("⚠️ Could not extract ABI, using empty array");
      abi = [];
    }
  }
  ...
  console.log("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  console.log("✅ DEPLOYMENT COMPLETE (WEEK 5)");
  console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
