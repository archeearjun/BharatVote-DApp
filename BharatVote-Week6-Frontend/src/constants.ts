// src/constants.ts - Week 6: Admin Dashboard & Deployment Automation
...
export const PHASE_HINTS: Record<Phase, string> = {
  0: "Cast your encrypted vote (commitment)",
  1: "Reveal your vote with the salt you stored",
...
export const UI_MESSAGES = {
  ...
  LOADING: "Loading...",
  COMMITTING_VOTE: "Committing your vote...",
  VOTE_COMMITTED: "Vote successfully committed!",
  VOTE_COMMIT_FAILED: "Failed to commit vote. Please try again.",
} as const;

// ---- Voting constants (Week 6) ----
export const VOTING = {
  SALT_STORAGE_KEY: "bharatvote_salt",
  CHOICE_STORAGE_KEY: "bharatvote_choice",
  COMMITMENT_STORAGE_KEY: "bharatvote_commitment",
  VOTER_ID_STORAGE_KEY: "bharatvote_voter_id", // Week 6: Store voter ID for Merkle proof fetching
} as const;
